...
function TinTucSingle({ pageContext, siteOptions, activePolyLangUrl, updateActivePolyLangUrl, UpdateSiteOptions, translationStrings }) {
    const router = useRouter();
    const [sizes, setSizes] = useState(null);
  const {siteOptions : mySiteOptions, seo, breadcrumbs, pageInfo, bannerOptions, postsSidebarList, featuredPostsSidebarList} = pageContext;
  useEffect(() => {
              ...
              <div className="container">
                  <div className="row gutter-50">
                      ...
                      <div className="col-lg-4">
                            <CategorySidebarTemplate title={getTranslation(translationStrings, "news_label")} 
                                                     data = {postsSidebarList} />
...
function mapStateToProps(state) {   
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(TinTucSingle);
