...
function HdxhSingle({ pageContext, siteOptions, activePolyLangUrl, updateActivePolyLangUrl, UpdateSiteOptions, translationStrings }) {
...
function mapStateToProps(state) {   
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(HdxhSingle);
