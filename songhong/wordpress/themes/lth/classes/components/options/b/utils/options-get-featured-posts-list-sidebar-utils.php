<?php 
    ...
    class OptionsFeaturedPostsListSidebarUtils {   
        public static function get($lang = 'vi', $limit = 2) {     
            $prefix = $lang === 'vi' ? '' : '_jp';        
            $args = array(
               'post_type' => 'post',
               'posts_per_page' => $limit,
               'lang' => $lang,
               'meta_key' => "advanced_post_options{$prefix}",
               'meta_value' => "show_on_featured_sidebar",
               'meta_compare' => "LIKE"
           );
